...
Bridge between world simulation and content generation.
Uses local ContentGenerator (self-contained, no external dependencies).
"""

from pathlib import Path
from typing import Optional, List, Dict, Any

# Import ContentGenerator from local module (same package)
...
class GeneratorAdapter:
    ...
    def __init__(self, seed: Optional[int] = None, data_dir: Optional[str] = None):
        ...
        Args:
            ...
            data_dir: Path to data directory (defaults to local Game/data)
        """
        if data_dir is None:
            # Default to local data directory (Game/src/../data)
